...
module RISC_V_Processor_2(
  ...
  //?????????????????????????????????????????????????????????????????????????????
  wire        IDEX_RegWrite, IDEX_MemRead, IDEX_MemToReg,
              IDEX_MemWrite, IDEX_Branch, IDEX_ALUSrc;
  wire [1:0]  IDEX_ALUOp;
  wire [3:0]  IDEX_Funct;
  ...
  //?????????????????????????????????????????????????????????????????????????????
  wire        EXM_RegWrite, EXM_MemRead, EXM_MemToReg,
              EXM_MemWrite, EXM_Branch, EXM_zero;
  ...
  assign PC_in = (EXM_Branch & EXM_zero)
               ? EXM_Adder_out
               : PC_plus4;
